...
/*      */ 
/*      */ 
/*      */ public class IORNACanvas
/*      */   extends JComponent
/*      */ {
/*   29 */   public static final int WIDTH = 500;
/*      */   
/*   31 */   public static final int HEIGHT = 300;
/*      */   
/*      */   private IORNACanvas.NetList netList;
/*   34 */   private boolean drawFlowInfo = false;
/*   35 */   private boolean drawCostInfo = false;
/*   36 */   private boolean drawLoopInfo = false;
/*      */   
/*   38 */   private char THETA = 'θ';
/*      */   
...
/*      */ 
/*      */ 
/*      */   public IORNACanvas(int w, int h, IORNAProcessController.NAData d)
/*      */   {
/*   51 */     this.width = w;
/*   52 */     this.height = h;
/*   53 */     setPreferredSize(new Dimension(this.width, this.height));
/*   54 */     setBackground(Color.white);
/*   55 */     setForeground(Color.red);
/*   56 */     this.netList = new IORNACanvas.NetList(d);
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/*      */     
/*   70 */     double w = d.getWidth();
/*   71 */     double h = d.getHeight();
/*      */     
/*   73 */     g2.fillRect(10, 10, (int)w - 20, (int)h - 20);
/*   74 */     g2.setColor(getForeground());
/*      */     
/*   76 */     this.netList.setCanvasRatio(w / this.width, h / this.height);
/*   77 */     this.netList.draw(g);
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/*      */   {
/*  108 */     private final int NE = 1;
/*  109 */     private final int NW = 2;
/*  110 */     private final int SW = 3;
/*  111 */     private final int SE = 4;
/*  112 */     private final int N = 11;
/*  113 */     private final int S = 12;
/*      */     
/*      */ 
/*  116 */     private final int r = 32;
/*      */     
/*      */ 
/*  119 */     private final int L0 = 6;
/*      */     
/*      */ 
/*  122 */     private double rx = 1.0D;
/*  123 */     private double ry = 1.0D;
/*      */     
/*      */ 
/*  126 */     int np = -1;
/*      */     
...
/*      */     int[] q;
/*      */     
/*  141 */     IORNAProcessController.NAData data = null;
/*      */     
/*      */     public NetList(IORNAProcessController.NAData d)
/*      */     {
/*  145 */       this.data = d;
/*      */       
...
/*  871 */         if ((IORNACanvas.this.drawFlowInfo) && (!IORNACanvas.this.drawCostInfo))
/*      */         {
/*  873 */           String sFlow = IORActionPanel.trim(getArcFlow(i));
/*  874 */           int j = 0;
/*  875 */           boolean b = false;
/*  876 */           if (IORNACanvas.this.drawLoopInfo) {
/*  877 */             while (this.data.cycle_arcs[j][0] > 0) {
/*  878 */               if (this.data.arcs[id].isEqualTo(this.data.cycle_arcs[j][0], this.data.cycle_arcs[j][1])) {
/*  879 */                 sFlow = String.valueOf(String.valueOf(new StringBuffer("(").append(sFlow).append(this.data.arcs[id].is_reversed ? String.valueOf(String.valueOf(new StringBuffer("-").append(IORNACanvas.this.THETA).append(")"))) : String.valueOf(String.valueOf(new StringBuffer("+").append(IORNACanvas.this.THETA).append(")"))))));
...
/*  886 */                 sFlow = String.valueOf(String.valueOf(new StringBuffer("(").append(sFlow).append(this.data.arcs[id].is_reversed ? String.valueOf(String.valueOf(new StringBuffer("+").append(IORNACanvas.this.THETA).append(")"))) : String.valueOf(String.valueOf(new StringBuffer("-").append(IORNACanvas.this.THETA).append(")"))))));
...
/*      */         
/*  906 */         if (IORNACanvas.this.drawCostInfo) {
/*  907 */           String sCost = IORActionPanel.trim(getArcCost(i));
/*      */           
/*      */ 
/*  910 */           if (IORNACanvas.this.drawLoopInfo) {
/*  911 */             int j = 0;
/*  912 */             while (this.data.cycle_arcs[j][0] > 0) {
/*  913 */               if (this.data.arcs[id].isEqualTo(this.data.cycle_arcs[j][0], this.data.cycle_arcs[j][1])) {
/*  914 */                 sCost = String.valueOf(String.valueOf(sCost)).concat(String.valueOf(String.valueOf(this.data.arcs[id].is_reversed ? String.valueOf(String.valueOf(new StringBuffer("(-").append(IORNACanvas.this.THETA).append(")"))) : String.valueOf(String.valueOf(new StringBuffer("(+").append(IORNACanvas.this.THETA).append(")"))))));
/*  915 */                 g2.setColor(Color.red);
/*      */                 
/*  917 */                 break;
/*      */               }
/*  919 */               if (this.data.arcs[id].isEqualTo(this.data.cycle_arcs[j][1], this.data.cycle_arcs[j][0])) {
/*  920 */                 sCost = String.valueOf(String.valueOf(sCost)).concat(String.valueOf(String.valueOf(this.data.arcs[id].is_reversed ? String.valueOf(String.valueOf(new StringBuffer("(+").append(IORNACanvas.this.THETA).append(")"))) : String.valueOf(String.valueOf(new StringBuffer("(-").append(IORNACanvas.this.THETA).append(")"))))));
...
/*  940 */         g2.setColor(IORNACanvas.this.getBackground());
...
/* Location:              C:\Program Files (x86)\Accelet\IORTutorial\IORTutorial.jar!\IORNACanvas.class
