...
/*     */   public String Wq;
/*     */   
/*     */   public phaseSA(IORSAWaitingLinePane app)
/*     */   {
/*  62 */     this.mainApp = app;
/*     */     try {
/*  64 */       jbInit();
...
/*     */       for (;;)
/*     */       {
/* 268 */         this.arrivaltime = (-Math.log(1 - Math.random()) / phaseSA.this.mainApp.u);
/* 269 */         phaseSA.this.arrivals += 1;
/* 270 */         phaseSA.this.addElapse(this.arrivaltime);
/*     */         try {
/* 272 */           sleep((int)(this.arrivaltime * phaseSA.this.MSEL));
/*     */         }
/*     */         catch (Exception e) {
/* 275 */           System.out.println("error");
/*     */         }
/*     */         
/* 278 */         phaseSA.this.dec.plugcusnum();
/*     */         
/* 280 */         phaseSA.this.repaint();
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */     {
/*     */       for (;;) {
/* 299 */         this.wait = phaseSA.this.dec.deccusnum();
/* 300 */         this.entertime = phaseSA.this.dec.getEnterTime();
/* 301 */         this.interval = (System.currentTimeMillis() - this.entertime);
/*     */         
/* 303 */         phaseSA.this.addWaitTime(this.interval * 1.0D / phaseSA.this.MSEL);
/*     */         
/* 305 */         this.servetime = (-Math.log(1 - Math.random()) / phaseSA.this.mainApp.a);
/* 306 */         phaseSA.this.addServTime(this.servetime);
/*     */         try
/*     */         {
/* 309 */           this.wholetime = (this.servetime * phaseSA.this.MSEL);
/*     */           
/* 311 */           phaseSA.this.midflag[this.sevNum] = 1;
/* 312 */           if (this.wait == false)
/* 313 */             phaseSA.this.flag[this.sevNum] = true;
/* 314 */           phaseSA.this.repaint();
/*     */           
...
/*     */           
/* 322 */           phaseSA.this.midflag[this.sevNum] = 0;
/* 323 */           phaseSA.this.flag[this.sevNum] = true;
/* 324 */           phaseSA.this.repaint();
/*     */           
...
/*     */         }
/* 331 */         phaseSA.this.flag[this.sevNum] = false;
/*     */         
/* 333 */         phaseSA.this.customnum1 += 1;
/*     */         
/* 335 */         phaseSA.this.repaint();
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */     {
/* 367 */       Thread tem = new phaseSA.sevice(i);
/* 368 */       this.threadvec.addElement(tem);
/* 369 */       tem.start();
/*     */     }
/* 371 */     Thread tem = new phaseSA.producecustom();
...
/* Location:              C:\Program Files (x86)\Accelet\IORTutorial\IORTutorial.jar!\phaseSA.class
