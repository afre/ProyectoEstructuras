...
/*     */   public String Wq;
/*     */   
/*     */   public phase2(IORWaitingLinePane app)
/*     */   {
/*  68 */     this.mainApp = app;
/*     */     try {
/*  70 */       jbInit();
...
/*     */     {
/*     */       for (;;) {
/* 341 */         this.arrivaltime = (-Math.log(1 - Math.random()) / phase2.this.mainApp.u);
/* 342 */         phase2.this.arrivals += 1;
/* 343 */         phase2.this.addElapse(this.arrivaltime);
/*     */         try {
/* 345 */           sleep((int)(this.arrivaltime * phase2.this.MSEL));
/*     */         }
/*     */         catch (Exception e) {
/* 348 */           System.out.println("error");
/*     */         }
/* 350 */         phase2.this.dec.plugcusnum();
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */     {
/*     */       for (;;) {
/* 368 */         this.wait = phase2.this.dec.deccusnum();
/* 369 */         this.entertime = phase2.this.dec.getEnterTime();
/* 370 */         this.interval = (System.currentTimeMillis() - this.entertime);
/*     */         
/* 372 */         phase2.this.addWaitTime(this.interval * 1.0D / phase2.this.MSEL);
/*     */         
/* 374 */         this.servetime = (-Math.log(1 - Math.random()) / phase2.this.mainApp.a);
/* 375 */         phase2.this.addServTime(this.servetime);
/*     */         try
/*     */         {
/* 378 */           this.wholetime = (this.servetime * phase2.this.MSEL);
/*     */           
/* 380 */           phase2.this.midflag[this.sevNum] = 1;
/* 381 */           if (this.wait == false) {
/* 382 */             phase2.this.flag[this.sevNum] = true;
/*     */           }
/* 384 */           phase2.this.repaint();
...
/*     */           
/* 391 */           phase2.this.midflag[this.sevNum] = 0;
/* 392 */           phase2.this.flag[this.sevNum] = true;
/* 393 */           phase2.this.repaint();
/*     */           
...
/*     */         }
/* 400 */         phase2.this.flag[this.sevNum] = false;
/* 401 */         phase2.this.dec1.plugcusnum();
/*     */         
/* 403 */         phase2.this.repaint();
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */       for (;;)
/*     */       {
/* 423 */         this.wait = phase2.this.dec1.deccusnum();
/* 424 */         this.entertime = phase2.this.dec1.getEnterTime();
/* 425 */         this.interval = (System.currentTimeMillis() - this.entertime);
/*     */         
/* 427 */         phase2.this.addWaitTime(this.interval * 1.0D / phase2.this.MSEL);
/*     */         
/* 429 */         this.servetime = (-Math.log(1 - Math.random()) / phase2.this.mainApp.a);
/* 430 */         phase2.this.addServTime(this.servetime);
/*     */         try
/*     */         {
/* 433 */           this.wholetime = (this.servetime * phase2.this.MSEL);
/*     */           
/* 435 */           phase2.this.midflag1[this.sevNum] = 1;
/* 436 */           if (this.wait == false)
/* 437 */             phase2.this.flag1[this.sevNum] = true;
/* 438 */           phase2.this.repaint();
/*     */           
...
/*     */           
/* 446 */           phase2.this.midflag1[this.sevNum] = 0;
/* 447 */           phase2.this.flag1[this.sevNum] = true;
/* 448 */           phase2.this.repaint();
/*     */           
...
/*     */         }
/* 455 */         phase2.this.flag1[this.sevNum] = false;
/* 456 */         phase2.this.customnum2 += 1;
/*     */         
/* 458 */         phase2.this.repaint();
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */     {
/* 493 */       Thread tem = new phase2.sevice(i);
...
/*     */     {
/* 500 */       Thread tem = new phase2.sevice1(i);
/* 501 */       this.threadvec.addElement(tem);
/* 502 */       tem.start();
/*     */     }
/*     */     
/* 505 */     Thread tem = new phase2.producecustom();
...
/* Location:              C:\Program Files (x86)\Accelet\IORTutorial\IORTutorial.jar!\phase2.class
